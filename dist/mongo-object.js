...
var _lodash3 = _interopRequireDefault(require("lodash.isobject"));

var _lodash4 = _interopRequireDefault(require("lodash.without"));
  ...
  _createClass(MongoObject, [{
    ...
    value: function _reParseObj() {
      ...
      function parseObj(self, val, currentPosition, affectedKey, operator, adjusted, isWithinArray) {
        ...
        if (Array.isArray(val) && val.length > 0) {
          ...
          (0, _lodash.default)(val, function (v, i) {
          ...
          // is a custom object.
          if (currentPosition && !(0, _lodash2.default)(val)) {
    ...
    value: function removeArrayItems() {
      ...
      function traverse(obj) {
        (0, _lodash.default)(obj, function (val, indexOrProp) {
          // Move deeper into the object
          ...
          if (MongoObject.isBasicObject(next)) {
            ...
            obj[indexOrProp] = (0, _lodash4.default)(next, REMOVED_MARKER);
    ...
    value: function _keyToPosition(key, wrapAll) {
      var position = '';
      (0, _lodash.default)(key.split('.'), function (piece, i) {
        if (i === 0 && !wrapAll) {
          position += piece;
        } else {
    ...
    value: function cleanNulls(doc, isArray, keepEmptyStrings) {
      ...
      Object.keys(doc).forEach(function (key) {
        ...
        if (!Array.isArray(val) && MongoObject.isBasicObject(val)) {
          ...
          if (!(0, _lodash2.default)(val)) newDoc[key] = val;
    ...
    value: function docToModifier(doc) {
      ...
      var modifier = {};
      if (!(0, _lodash2.default)(flatDoc)) modifier.$set = flatDoc;
      if (!(0, _lodash2.default)(nulls)) modifier.$unset = nulls;
      return modifier;
    }
    ...
    value: function expandObj(doc) {
      ...
      Object.keys(doc).forEach(function (key) {
        ...
        for (var i = 0; i < subkeylen; i++) {
          ...
          if (typeof current[subkey] !== 'undefined' && !(0, _lodash3.default)(current[subkey])) {
          ...
          if (i === subkeylen - 1) {
            ...
            if (isNaN(nextPiece) && !(0, _lodash3.default)(current[subkey])) {
              current[subkey] = {};
